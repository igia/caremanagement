...
/**
 * Spring Data  repository for the TaskAssociate entity.
 */

@Repository
public interface TaskAssociateRepository extends JpaRepository<TaskAssociate, Long> {

    List<TaskAssociate> findAllByTaskId(Long taskId);
    
    List<TaskAssociate> findAllByAssociateOn(Long associateOn);
}
