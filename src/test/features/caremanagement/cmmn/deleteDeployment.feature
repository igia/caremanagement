...
Feature: Deploy and create case definition instance in camunda
    ...
    * def accessToken = signIn.accessToken
    ...
    Scenario: Delete the deployment
        ...
        When method get
        Then status 200
        Then def depId = response
        Then def functDelete = call read('classpath:deleteDeployment.feature') depId
